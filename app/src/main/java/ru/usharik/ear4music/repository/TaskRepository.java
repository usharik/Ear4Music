...
import ru.usharik.ear4music.model.room.TaskRoomDao;
import ru.usharik.ear4music.model.room.TaskWithSubTasks;
...
public class TaskRepository {
    ...
    public void updateDonePercent(Task task) {
        ...
        int doneCnt = 0;
        for (ru.usharik.ear4music.model.SubTask subTask : taskWithSubTasks.subTasks) {
